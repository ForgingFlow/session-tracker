...
export default function SessionHistoryModal({ clientName, sessions, onClose, onDeleteSession }) {
  ...
  return (
    <>
      ...
      >
        <div className="bg-amber-dusk-darker rounded-t-2xl sm:rounded-xl p-6 border border-white/10 w-full sm:max-w-md sm:mx-4 max-h-[90vh] overflow-y-auto mt-auto sm:mt-0">
